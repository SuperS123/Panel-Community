...
module.exports = {
    name: "eval",
    description: "Evals a command duhh..",
    dm: true,
    aliases: ["ev"],
    run: function(client, message) {
			if (!global.config.get("discord.devs").includes(message.author.id)) {
    ...
    function clean(text) {
        ...
        text = text
            ...
            .replace(/@/g, '@' + String.fromCharCode(8203))
            .replace(rege, "You're so fucking gay for wanting that, stupid bitch.")
        return text;
    };
